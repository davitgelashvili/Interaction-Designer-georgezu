...
//         .to(".about-page__footer--slider", 0.5, {z: -150})		// move back in 3D space
//         .to(".about-page__footer--slider", 1,   {x: "-25%"})	// move in to first panel
//         .to(".about-page__footer--slider", 0.5, {z: 0})				// move back to origin in 3D space
//         // animate to third panel
//         .to(".about-page__footer--slider", 0.5, {z: -150, delay: 1})
//         .to(".about-page__footer--slider", 1,   {x: "-50%"})
//         .to(".about-page__footer--slider", 0.5, {z: 0})
//         // animate to forth panel
//         .to(".about-page__footer--slider", 0.5, {z: -150, delay: 1})
//         .to(".about-page__footer--slider", 1,   {x: "-75%"})
//         .to(".about-page__footer--slider", 0.5, {z: 0});

//     // create scene to pin and link animation
//     new ScrollMagic.Scene({
//             triggerElement: ".about-page__footer",
//             triggerHook: "onLeave",
//             duration: "500%"
//         })
//         .setPin(".about-page__footer")
...
// var panels = $(".about-page__footer--slider").find(".slider__item");
